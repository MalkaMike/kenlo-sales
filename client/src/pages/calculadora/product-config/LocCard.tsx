...
export function LocCard() {
  ...
  return (
    <Card className="bg-green-50/20 border-green-200/40 transition-all duration-200 ease-in-out hover:scale-[1.02] hover:shadow-md hover:border-green-400 cursor-pointer">
