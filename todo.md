...
## L-Bracket Hover Animation
- [x] Add hover state tracking for table sections (track which section is being hovered)
- [x] Implement smooth CSS transitions for L-bracket borders (color, width, shadow)
- [x] Add hover effects: border color brightening, subtle glow/shadow, border width increase (3px → 4px)
- [x] Ensure hover animation doesn't conflict with existing row hover states
- [x] Test hover animations across all sections (Produtos, Add-ons, Serviços Premium, Mensalidade, Implantação, Pós-Pago)
